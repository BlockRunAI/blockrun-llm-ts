...
The smart-routing SDK for <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models — every request goes to the cheapest model that can handle it,
...
| **Models**         | GPT only       | 200+              | 100+ (BYO keys)  | **<!-- br:models.chatVisible -->77<!-- /br:models.chatVisible -->, one credential** |
